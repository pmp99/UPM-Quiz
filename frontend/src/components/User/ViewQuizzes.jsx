                ...
                <Navbar/>
                    ...
                    {quizzes.length === 0 ?
                        <div style={{textAlign: "center"}}>
                            <h3 style={{textAlign: "center", padding: "30px"}}>No hay quizzes</h3>
                            {this.props.login.user.id === parseInt(this.props.match.params.userID) ?
                                <Button onClick={this.openQuiz.bind(this, false, null)} color="primary" variant="contained">Crear quiz</Button> : null}
                        </div> :
                        <div style={{display: "flex", flexDirection: "column"}}>
                            <div style={{display: "inline-flex", margin: "auto 4% auto auto", width: "100%"}}>
                                {this.props.login.user.id === parseInt(this.props.match.params.userID) ?
                                    <div style={{margin: "auto auto auto 5%"}}>
                                        <Button onClick={this.openQuiz.bind(this, false, null)} color="primary" variant="contained">Crear quiz</Button>
                                    </div> : null}
