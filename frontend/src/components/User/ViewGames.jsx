                ...
                <Navbar/>
                    ...
                    {myGames.length === 0 && gamesPlayed.length === 0 ?
                        <div style={{textAlign: "center"}}>
                            ...
                            {this.props.login.user.id === parseInt(this.props.match.params.userID) ? <h5>Pulsa <Link to={quizzesLink}>aquí</Link> para ver tus quizzes y empezar uno como anfitrión
