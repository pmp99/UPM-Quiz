...
class Navbar extends Component {
    ...
    render(){
        ...
        if (this.props.login.authenticated) {
            ...
            return(
                <nav style={{display: "flex", justifyContent: "space-between", backgroundColor: "#46178f", position: "sticky", top: "0", zIndex: "10"}}>
                    <button style={{marginRight: "10px", marginLeft: "10px"}} className="navButtonPic" onClick={this.home}><img src={kahootWhite} alt="Logo"/></button>
            ...
            return(
                <nav style={{display: "flex", justifyContent: "space-between", backgroundColor: "white", borderBottom: "2px solid grey", position: "sticky", top: "0", zIndex: "10"}}>
                    <button style={{marginRight: "10px", marginLeft: "10px"}} className="navButtonPicNoLogin" onClick={this.home}><img src={kahoot} alt="Logo"/></button>
